...
public class RegisterRequest extends StringRequest{  // this class will allow a request to be made to the Register.php file on the server and get a response as a string
